...
|---|---|---|---|
| `pico_faces_m3_decD_deep_full.uf2` | the QUALITY flagship: full-attention depth-12 DiT + decoder D, 45k distillation-QAT, blob v8. Device gen-FID 53.8 (N=5000, K=8 w=4) | `40c5e5a0` | ~10 s @ K=4 w=4, ~20 s @ K=8 w=8 |
